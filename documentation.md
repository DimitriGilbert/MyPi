...
```
MyPi, My Tools:
	target: what should we do ? [one of 'add-fstab' 'install' 'mesure' 'nfs-export' 'updater']
Usage :
	MyPi <target>
```
...
I send an SOS to the world:
	target: mesure what [one of 'cpu' 'gpu' 'ram' 'cpu']
Usage :
	MyPi mesure <target>
```
...
add nfs export:
	...
	-o, --options <options>: The options for the NFS share, repeatable
	--use-config|--no-use-config: use a config file, on by default (use --no-use-config to turn it off)
		no-aliases: --no-config,
Usage :
...
Usage :
	MyPi _install/apt [--cmd <value>] [--package <value>] [--config <value>] [--[no-]use-config] [--[no-]install-from-config]
```
...
install using apt:
	...
	--install-from-config|--no-install-from-config: install from config, on by default (use --no-install-from-config to turn it off)
Usage :
	bin/_install/apt [--cmd <value>] [--package <value>] [--config <value>] [--[no-]use-config] [--[no-]install-from-config]
```
...
install docker:
	...
	--install-from-config|--no-install-from-config: install from config, on by default (use --no-install-from-config to turn it off)
Usage :
	bin/_install/docker [--config <value>] [--[no-]use-config] [--[no-]install-from-config]
```

#### bin/_install/docker-cmd
...
run docker command:
	...
	--install-from-config|--no-install-from-config: install from config, on by default (use --no-install-from-config to turn it off)
Usage :
	bin/_install/docker-cmd [--config <value>] [--cmd <value>] [--[no-]use-config] [--[no-]install-from-config]
```
...
install using git:
	...
	--install-from-config|--no-install-from-config: install from config, on by default (use --no-install-from-config to turn it off)
Usage :
	bin/_install/git [--repo <value>] [--directory <value>] [--config <value>] [--[no-]use-config] [--[no-]install-from-config]
```
...
install oh my zsh:
	...
	--install-from-config|--no-install-from-config: install from config, on by default (use --no-install-from-config to turn it off)
Usage :
	bin/_install/omz [--config <value>] [--plugin <value>] [--[no-]use-config] [--[no-]install-from-config]
```
